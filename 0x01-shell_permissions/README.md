...
Write a script that adds execution permission to the owner, the group owner and
...
### [15. Symbolic link](./101-symbolic_link_permissions)
Write a script that changes the owner and the group owner of `_hello` to vincent and
staff respectively.
...
Write a script that changes the owner of the file `hello` to `betty` only if it is owned
